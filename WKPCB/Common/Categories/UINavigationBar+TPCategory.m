...
UIImageView *backgroundView;
 ...
 -(UIImage*)barBackground
 {
     ...
     //UIColor *col=[UIColor colorWithRed:224/255.0f green:48/255.0f blue:50/255.0f alpha:0.85f];
     //return [UIImage createImageWithColor:col];
     return [UIImage createImageWithColor:UIColorMakeRGB(239, 108, 50)];
 }
